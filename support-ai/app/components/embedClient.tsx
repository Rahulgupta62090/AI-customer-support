    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="flex justify-center px-4 py-14">
        ...
        >
          ...
          <div className="bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10">
            <div className="flex items-start gap-4">
              <pre className="flex-1 overflow-x-auto whitespace-pre-wrap break-words">{embedcode}</pre>
              <div className="flex flex-col items-end gap-2">
                <button
                  className="bg-white text-zinc-900 text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-zinc-200 transition"
                  onClick={copyCode}
                ...
                <a
                  ...
                  href={`${process.env.NEXT_PUBLIC_APP_URL ?? ""}/chatBot.js`}
                  target="_blank"
            ...
            <div className="rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden">
              ...
              >
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M6 4h9a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3H9l-4 3v-3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z" />
                </svg>
              </motion.div>
            </div>
          </div>
